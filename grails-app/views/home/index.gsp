...
<head>
<title><g:message code="default.welcotitleme.title" args="[meta(name:'app.name')]"/> </title>
        ...
        <div id="myCarousel" class="carousel slide">
          ...
          <div class="carousel-inner">
            <div class="item active">
              <img src="images/carouselIndex/22.jpg" alt="">
            ...
            <div class="item">
              <img src="images/carouselIndex/23.jpg" alt="">
              <div class="carousel-caption">
...
<div class="item">
              <img src="images/carouselIndex/24.jpg" alt="">
              <div class="carousel-caption">
                <h4>Second Thumbnail label</h4>
                <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
              </div>
...
<div class="container"> 
<div class="pull-right">&copy; Gestion Eventos 2012</div>
